...
public class CommandLineChatFH implements javax.jms.MessageListener{
	public static final String TOPIC="topic/aufgabe5Topic";
    public static void main(String[] args) throws NamingException, JMSException, IOException {
    	if (args.length!=1) System.out.println("Bitte den Username angeben.");
    	else {
    		String username=args[0];
    		CommandLineChatFH commandLineChat =new CommandLineChatFH();
    		Context initialContext =CommandLineChatFH.getInitialContext();
    		Topic topic=(Topic) initialContext.lookup(CommandLineChatFH.TOPIC);
    ...
    public void subscribe(TopicConnection topicConnection, Topic topic, CommandLineChatFH commandLineChat) throws JMSException{
    ...
    public void publisch(TopicConnection topicConnection, Topic topic, String username) throws JMSException, IOException{
